...
=======
              ...
              {payStatus === "idle" || payStatus === "generating" ? (
                <>
                  ...
                  {/* Amount */}
                  <div>
                    <div style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", marginBottom: 6, textTransform: "uppercase", letterSpacing: "0.07em" }}>Amount (USD)</div>
...
>>>>>>> 19b122fd6ce18926233c5ba49e1d5a5f66c8b4a6
                  ...
                  <button
                    ...
                    style={{
                      padding: "11px 20px", borderRadius: 10, fontSize: 13, fontWeight: 700, cursor: (!payAmount || !payStreamId) ? "not-allowed" : "pointer",
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      color: payStatus === "paid" ? "#34d399" : payStatus === "scanned" ? "#fbbf24" : "#67e8f9",
                    }}>
                      {payStatus === "paid"
                  ...
                  {payStatus !== "paid" && payCheckoutUrl && (
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10, padding: "16px", borderRadius: 12, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
                      ...
                      {/* Direct link — tap to open Paystack on this device */}
                      <a
                        href={payCheckoutUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        style={{ fontSize: 10, color: "#67e8f9", textDecoration: "underline", opacity: 0.7 }}
                      >
                        Open payment page ↗
                      </a>

                      {/* Show on stream toggle */}
                      <button
                        onClick={() => {
                          if (bs.qrActive) {
                  ...
                  {/* Stream overlay position sliders (compact) */}
                  {payStatus !== "paid" && (
                    <PositionSliders
                      pos={bs.qrPosition}
                      onChange={(p) => {
